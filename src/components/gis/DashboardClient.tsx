    ...
    <div className="h-screen flex flex-col bg-slate-950 font-sans overflow-hidden text-slate-100">
      ...
      <header className="bg-slate-900/95 backdrop-blur-md border-b border-slate-800 px-5 py-2.5 flex items-center justify-between shadow-xl z-30 shrink-0">
        <div className="flex items-center space-x-3.5">
          <div className="w-9 h-9 rounded-xl bg-slate-800 border border-slate-700/80 flex items-center justify-center font-bold text-sm text-emerald-400 shadow-xs shrink-0">
          ...
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="hidden sm:inline-block px-2 py-0.5 rounded-full text-[10px] font-bold bg-slate-800 text-emerald-400 border border-slate-700">
                KJPP TWR • SPI 106
              </span>
            </div>
            <p className="text-[10px] text-slate-400 font-medium">
              Sistem Informasi dan Pangkalan Data Properti Totok Warsito dan Rekan
            </p>
          </div>
        </div>
