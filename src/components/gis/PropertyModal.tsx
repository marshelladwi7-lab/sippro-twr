        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 text-xs">
          ...
          <div className="space-y-3.5 border-b border-slate-800/80 pb-5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full mt-1.5 p-2.5 bg-slate-950 border border-slate-700/80 rounded-xl text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all"
              />
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5">
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 px-3 py-1.5 bg-slate-950 border border-slate-700/80 rounded-xl text-xs text-slate-100 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all"
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 gap-3 bg-slate-950/80 p-3.5 rounded-xl border border-slate-800">
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 px-3 py-1.5 bg-slate-900 border border-slate-700 rounded-xl font-mono text-xs text-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-3 gap-2.5">
              <div>
                ...
                <select
                  ...
                  className="w-full mt-1 px-3 py-1.5 bg-slate-950 border border-slate-700/80 rounded-xl text-xs text-slate-100 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all cursor-pointer"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 px-3 py-1.5 bg-slate-950 border border-slate-700/80 rounded-xl font-mono text-xs text-slate-100 focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-3 gap-2.5">
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 px-3 py-1.5 bg-slate-950 border border-slate-700/80 rounded-xl font-mono text-xs text-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
                />
              </div>
              <div>
          ...
          <div className="space-y-3.5">
            ...
            <div className="grid grid-cols-3 gap-2.5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 px-3 py-1.5 bg-slate-950 border border-slate-700/80 rounded-xl font-mono text-xs text-slate-100 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 transition-all cursor-pointer"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full mt-1 px-3 py-2 bg-slate-950 border border-slate-700/80 rounded-xl text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all"
              />
            </div>
          </div>
          ...
          <div className="flex items-center justify-end space-x-2.5 pt-4 border-t border-slate-800">
            ...
            <button
              ...
              className="px-5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl text-xs shadow-xs active:scale-[0.98] transition-all flex items-center space-x-1.5 cursor-pointer disabled:opacity-50"
            >
